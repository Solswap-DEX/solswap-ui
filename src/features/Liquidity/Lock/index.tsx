...
import { ApiV3PoolInfoStandardItemCpmm, CpmmLockExtInfo } from '@solswap.cloud/raydium-sdk-v2'
            ...
            <Box color={colors.lightPurple} fontSize={['sm', 'md']} lineHeight="20px" mb={[4, 7]}>
              ...
              <Text mb={[4, 7]} color={colors.semanticWarning}>
                <Trans i18nKey="liquidity.lock_cpmm_desc4">
                  <Link href="https://docs.solswap.cloud/raydium/pool-creation/burn-and-earn" isExternal></Link>
                </Trans>
              </Text>
              <Text mb={[4, 7]}>

        ...
        description={
          isCreatePool ? (
            <Trans i18nKey="create_pool.modal_section_header_pool_desc">
              <Link href="https://docs.solswap.cloud/raydium/pool-creation/creating-a-clmm-pool-and-farm" isExternal>
                CLMM
              </Link>
              <Link href="https://docs.solswap.cloud/raydium/pool-creation/creating-a-standard-amm-pool" isExternal>
                Standard
              </Link>
            </Trans>
          ) : null
        ...
        description={
          isCreateFarm ? (
            <Trans i18nKey="create_pool.modal_section_header_farm_desc">
              ...
              <Link href="https://docs.solswap.cloud/raydium/pool-creation/creating-a-standard-amm-pool/creating-an-ecosystem-farm" isExternal>
                Standard
              </Link>
            </Trans>
          ) : null
        ...
        description={
          isLockPool ? (
            <Trans i18nKey="create_pool.modal_section_header_lock_desc">
              <Link href="https://docs.solswap.cloud/raydium/pool-creation/burn-and-earn" isExternal>
                Learn more
              </Link>
            </Trans>
          ) : null

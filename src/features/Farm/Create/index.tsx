...
import { ApiV3PoolInfoConcentratedItem, ApiV3PoolInfoItem, ApiV3PoolInfoStandardItem } from '@solswap.cloud/raydium-sdk-v2'
            ...
            description={
              <Text fontSize="sm" color={isMobile ? colors.textSecondary : colors.textTertiary}>
                <Trans i18nKey="create_farm.note_des">
                  ...
                  <Link
                    href="https://docs.solswap.cloud/raydium/pool-creation/creating-a-standard-amm-pool/creating-an-ecosystem-farm"
                    isExternal
                  >
                    Standard
                  </Link>

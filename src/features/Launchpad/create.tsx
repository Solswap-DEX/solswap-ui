...
import { LaunchpadPoolInitParam, FEE_RATE_DENOMINATOR_VALUE, Curve } from '@solswap.cloud/raydium-sdk-v2'
          ...
          <Box p={6} borderRadius="12px" backgroundColor={colors.backgroundLight}>
            ...
            <Text color="#C4D6FF80" fontSize="sm">
              ...
              <Link
                color="#22D1F8"
                target="_blank"
                href="https://docs.solswap.cloud/raydium/pool-creation/launchlab/create-a-token"

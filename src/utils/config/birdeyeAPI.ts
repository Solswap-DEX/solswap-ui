...
export const birdeyePairVolumeApiAddress = ({
  ...
  return `https://api.geckoterminal.com/api/v2/networks/solana/pools/${poolAddress}/ohlcv/${config.timeframe}?aggregate=${config.aggregate}&limit=1000&currency=usd&token=base`
}
...
export const birdeyePriceUrl = `https://lite-api.jup.ag/price/v1`

...
export default function SecondaryLogo(props: SvgIcon) {
  ...
  return (
    <svg width={width} height={height} viewBox="0 0 140 30" fill="none" className="chakra-icon" {...props}>
      <text
        ...
        fontSize="24"
        fontWeight="900"
        fill="url(#solswap_gradient_secondary)"
        letterSpacing="-0.5"
      >
        SOLSWAP
      </text>
      <defs>
        <linearGradient id="solswap_gradient_secondary" x1="0" y1="0" x2="140" y2="0" gradientUnits="userSpaceOnUse">

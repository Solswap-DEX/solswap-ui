...
import { ApiV3Token } from '@solswap.cloud/raydium-sdk-v2'
  ...
  public async getBars(
    ...
    try {
      ...
      const { data } = await axios.get(
        `https://birdeye-proxy.solswap.cloud/defi/ohlcv/base_quote?base_address=${solToWSol(
          symbolInfo.mintA

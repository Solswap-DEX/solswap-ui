      ...
      <Box flex={1} overflowY="auto" pr={1}>
        {sorted.length === 0 ? (
          <Box py={10} textAlign="center">
            <Text color="#ffffff" fontSize="xs" fontFamily="var(--radar-mono)">No high-momentum tokens yet.</Text>
            <Text color="#ffffff" fontSize="xs" fontFamily="var(--radar-mono)">Market is consolidating.</Text>
          </Box>
        ) : (
